...
//     std::stringstream file("var str = \"50\";");
...
//     std::stringstream file("var num = \"50\";");
//     vector<NodeType> visitors_activated{};
//     vector<string> lines{};
//     Visitor svisitor{visitors_activated};
//     NodeType expected[] = {
...
//     std::stringstream file("var num = 50 + 50;");
//     vector<NodeType> visitors_activated{};
//     vector<string> lines{};
//     Visitor svisitor{visitors_activated};
//     NodeType expected[] = {
...
//     std::stringstream file("num = 50 + 50;");
//     vector<NodeType> visitors_activated{};
//     vector<string> lines{};
//     Visitor svisitor{visitors_activated};
//     NodeType expected[] = {
